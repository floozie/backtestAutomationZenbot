...
namespace backtestAutomationZenbot
{
    ...
    class Program
    {
        private const string zenbotDir = "/home/floozie/crypto/zenbot";
        private const string zenbotAppName = "zenbot";
        private const string selector = "binance.BTC-USDT";
    
        private const string resultFolder ="/home/floozie/crypto/backtestAutomationZenbot/results";
